...
MOD.BarGroupTemplate = { -- default bar group settings
	...
	disableBGSFX = false, customizeSFX = false,	shineColor = false, glowColor = false,
	expireFGBG = false, flashPeriod = 1.2, flashPercent = 50, combatTextExcludesBG = false,
	shineStart = false, glowStart = false, flashStart = false, desatStart = false,
	shineExpiring = false, glowExpiring = false, flashExpiring = false, desatExpiring = false,
	...
	shineReady = false, glowReady = false, flashReady = false, desaturateReadyIcon = false,
	shineEnd = false, ghost = false, hide = false, fade = false,
	...
	timelinePercent = 50, timelineOffset = 0, timelineDelta = 0,
...
MOD.BarGroupLayoutTemplate = { -- all the bar group settings involved in layout configuration
	...
	timelinePercent = 0, timelineOffset = 0, timelineDelta = 0,
...
function MOD:UpdateBarGroup(bp)
	if bp.enabled then
		...
		MOD.Nest_SetBarGroupTimeline(bg, bp.timelineWidth, bp.timelineHeight, bp.timelineDuration, bp.timelineExp, bp.timelineHide, bp.timelineAlternate,
			bp.timelineSwitch, bp.timelinePercent, bp.timelineOffset, bp.timelineDelta,
...
local function UpdateBar(bp, vbp, bg, b, icon, timeLeft, duration, count, btype, ttType, ttID, ttUnit, ttCaster, isMine)
	...
	if bar then
		...
		bat.shineColor = wc; bat.glowColor = wc -- first set defaults for customization options
