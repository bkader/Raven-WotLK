...
local range_tables = {
	enemy = { DEATHKNIGHT = { 49576, 127344 }, DRUID = { 8921, 339, 6795 }, HUNTER = { 193455, 19434, 193265 }, MAGE = { 133 }, PALADIN = { 62124, 20271 },
		PRIEST = { 589 }, ROGUE = { 1725 }, SHAMAN = { 403, 188196, 187837 }, WARLOCK = { 215279, 196657 }, WARRIOR = { 355 }},
...
function MOD:UpdateConditions()
	...
	if (MOD.myClass == "DRUID") and IsSpellKnown(78674) then -- Balance Druid special case for mana as power plus separate lunar Power
		m = UnitPowerMax("player", 0); if m > 0 then stat.power = (100 * UnitPower("player", 0) / m) else stat.power = 0 end
